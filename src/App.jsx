...
const CATALOGUE_ITEMS = [
  ...
  { id: 2, title: "Minimalist French Windows", category: "Windows", price: "Custom Quote", img: "/window.jpg" },
  { id: 3, title: "Industrial Staircase Railing", category: "Fabrication", price: "From ₹2,200/sq.ft", img: "/rail.jpg" },
  { id: 4, title: "Modern Main Door Frame", category: "Doors", price: "From ₹4,500/sq.ft", img: "" }, // Leaves the blueprint icon if empty
  { id: 5, title: "Soundproof Steel Casement", category: "Windows", price: "Custom Quote", img: "" },
  { id: 6, title: "Custom Mezzanine Structure", category: "Fabrication", price: "Site Visit Required", img: "" },
];
...
export default function App() {
  ...
  return (
    ...
    <div className="min-h-screen bg-[#0a0f16] text-steel-100 font-sans selection:bg-industrial selection:text-white pb-20 lg:pb-0">
      ...
      <section id="compare" className="py-24 bg-[#0a0f16] border-t border-steel-800/30">
        <div className="max-w-7xl mx-auto px-6">
      ...
      {/* --- FOOTER & CONTACT --- */}
      <footer className="bg-[#05080c] pt-24 pb-12 border-t-4 border-industrial">
